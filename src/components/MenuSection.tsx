...
const categories: Record<string, MenuItem[]> = {
  "Hot Beverages": [
    ...
    { name: "Green Tea", desc: "Light and refreshing Japanese-style green tea", price: "₹59", image: menuChai },
    { name: "Espresso", desc: "Intense single-origin shot, rich crema finish", price: "₹79", image: menuCoffee },
    { name: "Americano", desc: "Double espresso with hot water for a smooth, long coffee", price: "₹99", image: menuCoffee },
    ...
    { name: "Café Latte", desc: "Smooth espresso blended with steamed milk and light foam", price: "₹129", image: menuCappuccino },
    { name: "Café Mocha", desc: "Espresso, steamed milk, and Belgian chocolate, topped with cream", price: "₹149", image: menuHotChoc },
    { name: "Hot Chocolate", desc: "Rich Belgian cocoa topped with whipped cream & cocoa dust", price: "₹139", image: menuHotChoc },
    { name: "Turmeric Latte", desc: "Golden milk with turmeric, honey, cinnamon & warm spices", price: "₹119", image: menuChai },
  ],
  "Cold Beverages": [
    { name: "Iced Tea", desc: "Chilled lemon tea with fresh mint and honey", price: "₹69", image: menuLassi },
    { name: "Mango Lassi", desc: "Creamy yogurt blended with fresh Alphonso mango pulp", price: "₹89", image: menuLassi, popular: true },
    { name: "Fresh Lime Soda", desc: "Refreshing lime with soda, mint and a pinch of rock salt", price: "₹59", image: menuLassi },
    { name: "Cold Coffee", desc: "Chilled blended coffee with milk and a hint of vanilla", price: "₹119", image: menuColdBrew },
    ...
    { name: "Berry Smoothie", desc: "Mixed berries, banana, yogurt & a drizzle of honey", price: "₹149", image: menuSmoothie },
    { name: "Oreo Milkshake", desc: "Thick creamy shake blended with Oreo cookies & ice cream", price: "₹159", image: menuIcedCoffee },
  ],
  Snacks: [
    ...
    { name: "Chocolate Chip Cookie", desc: "Warm, gooey cookie loaded with Belgian chocolate chips", price: "₹59", image: menuBrownie },
    { name: "Veg Puff", desc: "Flaky pastry filled with spiced potato and peas", price: "₹49", image: menuWrap },
    { name: "Grilled Cheese Sandwich", desc: "Crispy golden bread with melted cheddar and herbs", price: "₹129", image: menuSandwich },
    { name: "Club Sandwich", desc: "Triple-layered with chicken, egg, lettuce, tomato & mayo", price: "₹169", image: menuSandwich },
    ...
    { name: "Chicken Tikka Wrap", desc: "Smoky tandoori chicken, onion, peppers in a warm tortilla", price: "₹179", image: menuWrap },
  ...
  Desserts: [
    ...
    { name: "Rasgulla (2 pcs)", desc: "Spongy cottage cheese balls in light sugar syrup", price: "₹69", image: menuGulabJamun },
    { name: "Chocolate Brownie", desc: "Rich, fudgy brownie with walnuts and cocoa glaze", price: "₹99", image: menuBrownie },
    { name: "Brownie with Ice Cream", desc: "Warm brownie topped with vanilla ice cream & chocolate drizzle", price: "₹149", image: menuBrownie, popular: true },
    ...
    { name: "Blueberry Cheesecake", desc: "Classic baked cheesecake with tangy blueberry compote", price: "₹199", image: menuCheesecake },
    { name: "Nutella Waffle", desc: "Crispy Belgian waffle drizzled with Nutella & fresh bananas", price: "₹179", image: menuBrownie },
    { name: "Ice Cream Sundae", desc: "Three scoops with hot fudge, nuts, whipped cream & cherry", price: "₹169", image: menuDessert },
  ],
  "Main Course": [
    { name: "Margherita Pizza", desc: "Wood-fired crust, fresh mozzarella, basil, San Marzano tomatoes", price: "₹249", image: menuPizza },
    { name: "Farmhouse Pizza", desc: "Loaded with bell peppers, onions, mushrooms, olives & corn", price: "₹279", image: menuPizza },
    { name: "Penne Arrabiata", desc: "Penne pasta in a spicy tomato sauce with garlic and basil", price: "₹219", image: menuSpecial },
    { name: "Alfredo Pasta", desc: "Creamy white sauce pasta with mushrooms and parmesan", price: "₹239", image: menuSpecial },
    ...
    { name: "Paneer Butter Masala", desc: "Cottage cheese cubes in a rich, creamy tomato-butter gravy", price: "₹249", image: menuButterChicken },
    { name: "Dal Makhani with Rice", desc: "Slow-cooked black lentils in butter cream, served with jeera rice", price: "₹219", image: menuButterChicken },
    { name: "Chicken Biryani", desc: "Fragrant basmati rice layered with spiced chicken & saffron", price: "₹269", image: menuButterChicken, popular: true },
    { name: "Veg Biryani", desc: "Aromatic basmati rice with seasonal vegetables & whole spices", price: "₹219", image: menuButterChicken },
  ],
};
