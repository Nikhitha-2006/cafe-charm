...
const categories: Record<string, MenuItem[]> = {
  ...
  "Chef's Specials": [
    { name: "Chole Bhature", desc: "Spicy chickpea curry with fluffy fried bread, onion & chutney", price: "₹149", image: menuCholeBhature, popular: true },
    { name: "Pav Bhaji", desc: "Buttery mashed veggie curry with toasted pav, onion & lemon", price: "₹139", image: menuPavBhaji, popular: true },
    { name: "Masala Dosa", desc: "Crispy golden crepe with spiced potato, sambar & coconut chutney", price: "₹129", image: menuMasalaDosa, popular: true },
    { name: "Raj Kachori Chaat", desc: "Crispy kachori with yogurt, chutneys, pomegranate & sev", price: "₹119", image: menuRajKachori },
    { name: "Paneer Tikka Platter", desc: "Charred tandoori paneer skewers with peppers & mint chutney", price: "₹199", image: menuPaneerTikka, popular: true },
    { name: "Loaded Nachos", desc: "Crispy tortilla chips with cheese, jalapeños, salsa & sour cream", price: "₹199", image: menuNachos },
    { name: "Shakshuka", desc: "Poached eggs in spiced tomato sauce, served with crusty sourdough", price: "₹229", image: menuShakshuka },
    ...
    { name: "Crispy Chicken Burger", desc: "Buttermilk fried chicken, coleslaw, pickles on a brioche bun", price: "₹269", image: menuBurger },
  ],
};
